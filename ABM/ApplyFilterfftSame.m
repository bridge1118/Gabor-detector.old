function [allFiltered] = ApplyFilterfftSame(I, allFilter, localHalfx, localHalfy, doubleOrNot, thresholdFactor);
...
for (i = 1 : numImage)
   ...
   if (doubleOrNot>0)
       ClocalNormalizeDouble(sx, sy, numOrient, h, localHalfx, localHalfy, allFiltered(i, :), thresholdFactor); 
   end
   if (doubleOrNot<0)
